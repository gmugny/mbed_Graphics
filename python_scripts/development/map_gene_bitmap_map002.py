...
path_in = '/home/pi/Documents/mbed_Graphics/bitmap_maps/test_map_002.bmp'
...
np.savetxt('/home/pi/Documents/mbed_Graphics/output_maps/map002.out', this_map, delimiter=',',fmt='%i',newline=',\n')
np.savetxt('/home/pi/Documents/mbed_Graphics/output_maps/map002_npc.out', npc_map, delimiter=',',fmt='%i',newline=',\n')
np.savetxt('/home/pi/Documents/mbed_Graphics/output_maps/map002_collision.out', collision_map, delimiter=',',fmt='%i',newline=',\n')
